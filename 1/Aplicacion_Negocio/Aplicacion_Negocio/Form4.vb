...
Public Class Añadir
    ...
    Private Sub Mostrar()
        ...
        ods.Tables.Add("stock")
        oda.Fill(ods.Tables("stock"))
        DataGridView1.DataSource = ods.Tables("stock")
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        sql = "INSERT INTO stock (producto, marca, precio, peso, sabor, cantidad) values ('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "')"
